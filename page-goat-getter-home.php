...
<div class="gg-body">
    ...
    <section class="gg-hero">
        ...
        <div class="gg-container gg-hero-inner">
            <div class="gg-hero-text">
                <div class="gg-hero-badge">Built for the Gravity Forms Ecosystem</div>
                <h1>Powerful WordPress Plugins That <span class="gg-gradient-text">Extend Gravity Forms</span></h1>
                <p class="gg-hero-desc">Visual pipelines, Google Chat notifications, AMS integrations, and more — built by developers who live in Gravity Forms every day.</p>
                <div class="gg-hero-actions">
                    <a href="#plugins" class="gg-btn gg-btn-primary gg-btn-lg">Browse Plugins</a>
                    <a href="<?php echo home_url('/my-account/'); ?>" class="gg-btn gg-btn-ghost gg-btn-lg">Manage Licenses ↗</a>
                </div>
                <div class="gg-hero-stats">
                    <div class="gg-stat"><span class="gg-stat-num">4</span><span class="gg-stat-label">Plugins</span></div>
                    <div class="gg-stat-sep"></div>
                    <div class="gg-stat"><span class="gg-stat-num">∞</span><span class="gg-stat-label">Forms Supported</span></div>
                    <div class="gg-stat-sep"></div>
                    <div class="gg-stat"><span class="gg-stat-num">24/7</span><span class="gg-stat-label">Updates</span></div>
                </div>
            </div>
    ...
    <!-- ═══════════ PLUGINS ═══════════ -->
    <section id="plugins" class="gg-section">
            ...
            <div class="gg-plugins-grid">
                ...
                <div class="gg-plugin-card">
                    ...
                    <ul class="gg-plugin-features">
                        ...
                        <li>Custom entry statuses</li>
                        <li>In-line entry editing</li>
                        <li>Search and filter entries</li>
                        <li>1 pipeline per form</li>
                    </ul>
                    ...
                    <div class="gg-plugin-actions">
                        <a href="<?php echo home_url('/product/gravity-pipeline-free/'); ?>" class="gg-btn gg-btn-outline gg-btn-block" id="pipeline-free-cta">Download Free</a>
                    </div>
                </div>
                ...
                <div class="gg-plugin-card gg-card-pro">
                    ...
                    <ul class="gg-plugin-features">
                        ...
                        <li>Group assignments & managers</li>
                        <li>Bulk entry operations</li>
                        <li>Advanced notification panel</li>
                        <li>Entry activity history</li>
                        <li>Additional columns & statuses</li>
                        <li>Unlimited pipelines per form</li>
                    </ul>
                    <div class="gg-plugin-pricing">
                        <div class="gg-price-pro">
                            <span class="gg-price-label">Starting at</span>
                            <span class="gg-price-val">$9<small>/mo</small></span>
                        </div>
                    </div>
                    <div class="gg-plugin-actions">
    ...
    <!-- ═══════════ WHY GOAT GETTER ═══════════ -->
    <section id="why" class="gg-section gg-section-alt">
        <div class="gg-container">
            <div class="gg-section-head">
                <div class="gg-tag">Why Goat Getter</div>
    ...
    <!-- ═══════════ COMING SOON ═══════════ -->
    <section id="coming-soon" class="gg-section">
        <div class="gg-container">
            <div class="gg-section-head">
                <div class="gg-tag">Roadmap</div>
                <h2>Coming Soon</h2>
    ...
    <!-- ═══════════ CTA ═══════════ -->
    <section class="gg-cta-section">
        <div class="gg-container gg-cta-inner">
            <h2>Ready to Supercharge Your Gravity Forms?</h2>
            <p>Start with our free plugins, or go Pro and unlock the full toolkit.</p>
            <div class="gg-cta-buttons">
                <a href="#plugins" class="gg-btn gg-btn-primary gg-btn-lg">Browse Plugins</a>
                <a href="<?php echo home_url('/my-account/'); ?>" class="gg-btn gg-btn-ghost gg-btn-lg">Manage Licenses</a>
            </div>
        </div>
